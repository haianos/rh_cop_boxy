...
px_constraint.behaviour.specification = 1;
...
py_constraint.behaviour.specification = 1;
...
pz_constraint.behaviour.specification = 1;
...
pz_away_constraint.behaviour.specification = 1;
...
m.comparison_type = MonitorSpec.IN_INTERVAL;
m.monitored_variable_type = MonitorSpec.POS;
m.lower_bound = -0.005+away_traj.target;
m.upper_bound = 0.005+away_traj.target;
g.monitors.append(m)
